...
- [x] Slice 5: tool program
  ...
  - `execute` now runs a single top-level Effect program; internal LSP requests, edits, approvals, and changed-file sync compose through Effects.
