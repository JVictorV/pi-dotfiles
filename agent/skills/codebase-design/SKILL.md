...
- **Exploring alternative interfaces** — see [DESIGN-IT-TWICE.md](DESIGN-IT-TWICE.md): produce several radically different interface designs independently from the original brief, then compare on depth, locality, and seam placement.
